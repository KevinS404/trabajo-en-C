...
int verificarCruzarC(estado estadoActual){
	if(estadoActual.izq[2] == 1){
		if(estadoActual.izq[0] - 1 >= 0 &&  estadoActual.der[1] == 0){
			return 1;
		}
	}
	//el barco esta en la derecha
	else if(estadoActual.der[2] == 1){
		if(estadoActual.der[0] - 1 >=0 && (estadoActual.izq[0] + 1<=estadoActual.izq[1]+1) || estadoActual.der[1] == 0){
			return 1;
		}	
	}
	else{
...
int verificarCyM(estado estadoActual){
	if(estadoActual.izq[2]== 1){
		if(estadoActual.izq[0] - 1>=0 && estadoActual.izq[1] - 1 >= 0 && estadoActual.izq[0]  <= estadoActual.izq[1]  && estadoActual.der[0] + 1 <= estadoActual.der[1] + 1){
		return 1;
		}
	}
	if(estadoActual.der[2]== 1){
		if(estadoActual.der[0] - 1>=0 && estadoActual.der[1] - 1 >= 0 && estadoActual.der[0]-1 <= estadoActual.der[1]-1 && estadoActual.izq[0]+1 <= estadoActual.izq[0]+1){
			return 1;
		}
	}
	else{
...
int verificar2C(estado estadoActual){
	if(estadoActual.izq[2] == 1 && estadoActual.der[1]<2){
		if(estadoActual.izq[0] - 2 >= 0 && estadoActual.der[1] >= 0){
			return 1;
		}
	}
	else if(estadoActual.der[2]== 1 && estadoActual.izq[1]<2){
		if(estadoActual.der[0] - 2 >= 0 && estadoActual.der[1] >= 0){
			return 1;
		}
	}
